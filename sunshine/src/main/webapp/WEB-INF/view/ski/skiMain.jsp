...
<link rel="stylesheet" href="../ski/main.css" />
</head>
...
<!-- Highlights -->
	<section class="wrapper">
			<header>
	<a href="contentsRegist" class="icon fa-vcard-o"><span class="label">Icon</span></a>
							<div class="main_menu"><h3>컨텐츠 등록</h3></div>
	<a href="contentsList" class="icon fa-vcard-o"><span class="label">Icon</span></a>
							<div class="main_menu"><h3>컨텐츠 관리</h3></div>
			</header>
	</section>
