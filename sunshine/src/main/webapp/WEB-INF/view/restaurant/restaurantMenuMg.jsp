...
<div id="main">
	...
	<div id="menu" class="box">
		...
		<ul class="box">
			...
			<li><a href="restaurantBookMg"><span>예약관리</span></a></li>
			<li><a href="restaurantMenuMg"><span>메뉴관리</span></a></li>
			<li><a href="restaurantRsMg"><span>룸서비스관리</span></a></li>
			<li><a href="restaurantOrderMg"><span>주문관리</span></a></li>
			<li><a href="restaurantPayMg"><span>결제관리</span></a></li>
			<li><a href="#"><span>메인으로</span></a></li>
		</ul>
